...
async def main():
    ...
    result = await client.connect_connector(app_name=AppName.GOOGLE_CALENDAR, gl_token=os.getenv("GL_CONNECTORS_USER_TOKEN"), request=ConnectorConnectRequest(callback_url=os.getenv("GL_CONNECTORS_DEFAULT_CALLBACK_URL")))
