...
async def main():
    ...
    result = await _handle_stream(client.search_web, GetWebSearchResultsRequest(query="What is cloud computing?", result_type="snippets", size=5, site=["https://python.org", "https://docs.python.org"], search_mode=WebSearchEngine.AUTO))
