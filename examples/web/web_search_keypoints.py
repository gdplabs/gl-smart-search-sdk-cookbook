...
async def main():
    ...
    result = await client.search_web(GetWebSearchResultsRequest(query="Python programming best practices", result_type="keypoints", size=3, search_mode=WebSearchEngine.AUTO))
