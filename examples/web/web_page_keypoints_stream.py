...
async def main():
    ...
    result = await _handle_stream(client.get_web_page_keypoints, GetWebPageKeypointsRequest(query="Python programming concepts", source="https://docs.python.org/3/tutorial/", size=3))
