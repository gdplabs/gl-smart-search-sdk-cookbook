...
async def main():
    ...
    result = await client.search_web_urls(GetWebSearchUrlsRequest(
        query="Python programming tutorials", size=5,
        site=["https://python.org", "https://realpython.com"], search_mode=WebSearchEngine.AUTO
    ))
