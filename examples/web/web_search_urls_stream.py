"""Streaming web search URLs example."""
...
async def main():
    ...
    result = await _handle_stream(client.search_web_urls, GetWebSearchUrlsRequest(query="Python programming tutorials", size=5, site=["https://python.org", "https://docs.python.org"], search_mode=WebSearchEngine.AUTO))
