...
async def main():
    ...
    result = await _handle_stream(client.search_web_map, GetWebSearchMapRequest(
        base_url="https://firecrawl.dev", size=10, include_subdomains=False,
        query="scraping", page=1, return_all_map=False
    ))
