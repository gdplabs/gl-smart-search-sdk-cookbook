...
async def main():
    ...
    result = await _handle_stream(client.get_web_page_snippets, GetWebPageSnippetsRequest(
        query="Python tutorial", source="https://docs.python.org/3/tutorial/", size=3, snippet_style="paragraph", search_mode=WebSearchEngine.AUTO
    ))
