"""Streaming web search keypoints example."""
...
async def main():
    ...
    result = await _handle_stream(client.search_web, GetWebSearchResultsRequest(query="Python programming best practices", result_type="keypoints", size=3, search_mode=WebSearchEngine.AUTO))
